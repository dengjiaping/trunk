...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    public void onResume() {
        ...
        messageListPanel.reload(mContainer, null);
    ...
    private void parseIntent() {
        ...
        mContainer = new Container(getActivity(), sessionId, sessionType, this);

        if (messageListPanel == null) {
            messageListPanel = new MessageListPanel(mContainer, rootView, anchor, false, false);
        } else {
            messageListPanel.reload(mContainer, anchor);
        }

        if (inputPanel == null) {
            inputPanel = new InputPanel(mContainer, rootView, getActionList());
            inputPanel.setCustomization(customization);
        } else {
            inputPanel.reload(mContainer, customization);
        }
