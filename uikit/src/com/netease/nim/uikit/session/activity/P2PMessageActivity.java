...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private void initTitle() {
        ...
        RelativeLayout layout_left = (RelativeLayout) findViewById(R.id.title_left);
        FrameLayout layout_right = (FrameLayout) findViewById(R.id.title_right);
        TextView title = (TextView) findViewById(R.id.title_middle_text);
        ImageView image_right = (ImageView) findViewById(R.id.title_right_image);
        ...
        image_right.setImageResource(R.drawable.card);
