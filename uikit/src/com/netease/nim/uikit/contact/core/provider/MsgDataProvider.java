...
// * 消息全文检索数据提供者
// */
//public final myclass MsgDataProvider {
//
...
//        if (anchor != null) {
//            result = NIMClient.getService(LuceneService.myclass).searchSessionNextPageBlock(query, sessionType, sessionId, anchor, 50);
//        } else {
//            result = NIMClient.getService(LuceneService.myclass).searchSessionBlock(query, sessionType, sessionId);
//        }
//
...
//        long startTime = System.currentTimeMillis();
//        List<MsgIndexRecord> result = NIMClient.getService(LuceneService.myclass).searchAllSessionBlock(query, -1);
