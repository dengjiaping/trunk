...
//import com.histudent.jwsoft.histudent.body.message.uikit.location.activity.LocationExtras;
//import com.histudent.jwsoft.histudent.commen.activity.BaseActivity;
//import com.histudent.jwsoft.histudent.commen.activity.MyWebActivity;
//import com.histudent.jwsoft.histudent.commen.utils.DataTools;
//
//
...
////                   if (((DragAdapter) getAdapter()).getTag()==1){
////
////                       DragAdapter.selectedPos=downPos;
////                }
//
//                    Log.e("===>","选中项"+ DragAdapter.selectedPos + ",单击项："
//                            + downPos);
//
...
//
//                    Log.e("===>",isMoving==true?"true":"false");
//                    if (!isMoving) {
//                        OnMove(x, y);
//                    }
//
//                    Log.e("===>","pointToPosition"+pointToPosition(x,y));
...
//            Log.e("===>","windowManager"+windowParams.x+"---"+windowParams.y);
//        }
//    }
//
//    /**
...
//
//        Log.e("===>","OnItemLongClickListener1"+ pointToPosition((int) ev.getX(), (int) ev.getY())+""+DragAdapter.selectedPos);
//        int clickPos = pointToPosition((int) ev.getX(), (int) ev.getY());
...
//
//
//                    Log.e("===>","OnItemLongClickListener"+position);
////                    EditApplicationActivity.onItemClick.onItemClick(null, true);
//                    if (((DragAdapter) getAdapter()).getTag()!=1)
//                    ((DragAdapter) getAdapter()).setTag(1);
//
...
//                            .findViewById(R.id.find_gird_view_tv);
...
//
//                //当没有显示移动标记时点击每个item跳转到对应的界面
//                if (((DragAdapter) getAdapter()).getTag() == 0) {
//
//                    HuodongBean bean = ((HuodongBean) ((DragAdapter) getAdapter()).getChannnelLst().get(position));
//
//                    MyWebActivity.start(((BaseActivity) ctx), bean.getAppUrl());
//                }else {
//                    startPosition = position;// 第一次点击的postion
//                    dragPosition = position;
//                }
...
//
//        Log.e("===>","OnMove"+dPosition+"--"+dragPosition);
