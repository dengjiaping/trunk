            ...
            switch (msg.what) {
                case 888:
                    ...
                    if (orientation > 45 && orientation < 135) {
                        EventBus.getDefault().post(new ScreenSwitchEvent(2));
                    } else if (orientation > 135 && orientation < 225) {
                        EventBus.getDefault().post(new ScreenSwitchEvent(3));
                    } else if (orientation > 225 && orientation < 315) {
                        if (isPortrait) {
                            // 切换成横屏
                            isPortrait = false;
                            EventBus.getDefault().post(new ScreenSwitchEvent(0));
                        }
