package com.histudent.jwsoft.histudent.view.adapter.decoration;
...
/**
 * Created by lichaojie on 2017/9/30.
 * desc:
 * RecyclerView分割线
 */
...
public class Divider extends RecyclerView.ItemDecoration {
    ...
    public Divider setMargin(int left, int top, int right, int bottom) {
    ...
    public Divider setHeight(int height) {
        this.height = height;
        return this;
    }

    public Divider setWidth(int width) {
        this.width = width;
        return this;
    }
