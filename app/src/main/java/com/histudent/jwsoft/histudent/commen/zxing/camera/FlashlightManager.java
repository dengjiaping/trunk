...
package com.histudent.jwsoft.histudent.commen.zxing.camera;
...
/**
 * This myclass is used to activate the weak light on some camera phones (not flash)
 ...
 * Thanks to Ryan Alford for pointing out the availability of this myclass.
 */
final class FlashlightManager {
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      Log.w(TAG, "Unexpected error while finding myclass " + name, re);
      return null;
    }
  }
