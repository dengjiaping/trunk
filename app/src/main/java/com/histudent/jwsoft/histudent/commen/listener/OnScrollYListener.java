...
public abstract class OnScrollYListener implements OnScrollListener{
    ...
    public OnScrollYListener(PullToRefreshListView listView) {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if(mListView==null||mListView.getRefreshableView().getAdapter()==null){
            return;
        }
    ...
    private int computeScrollY(int firstVisibleItem, View firstVisibleChild){
        ...
        HiStudentLog.e("222222=====1==="+sum+"-------"+count);
        //已经记录的item的高度的平均值
