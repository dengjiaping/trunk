...
import com.histudent.jwsoft.histudent.body.message.activity.MyMessageActivity;
...
import com.histudent.jwsoft.histudent.body.mine.activity.NotificationActivity;
 ...
 */
public class HiStudentApplication extends MultiDexApplication {

    //false: 测试，true:生产
    public static boolean isOnLine = false;

    private static HiStudentApplication instance;

    public static synchronized HiStudentApplication getInstance() {
        return instance;
    }
...
//                intent.setClass(context.getApplicationContext(), OfficialChatActivity.class);
