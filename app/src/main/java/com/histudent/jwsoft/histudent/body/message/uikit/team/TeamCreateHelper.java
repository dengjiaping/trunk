package com.histudent.jwsoft.histudent.body.message.uikit.team;
...
//import com.histudent.jwsoft.histudent.commen.keyword.activity.MainActivity;
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, TeamTypeEnum.Normal, "",
                ...
                new RequestCallback<Team>() {
                    ...
                    public void onSuccess(Team team) {
                        ...
                        if (isNeedBack) {
//                            SessionHelper.startTeamSession(context, team.getId(), MainActivity.myclass, null); // 进入创建的群
                        } else {
                            SessionHelper.startTeamSession(context, team.getId(),false);
                        }
                        if (callback != null) {
    ...
    private static void onCreateSuccess(final Context context, final Team team) {
        ...
        new Handler(context.getMainLooper()).postDelayed(new Runnable() {
            @Override
            public void run() {
                SessionHelper.startTeamSession(context, team.getId(),false); // 进入创建的群
            }
        }, 50);
    }
}
