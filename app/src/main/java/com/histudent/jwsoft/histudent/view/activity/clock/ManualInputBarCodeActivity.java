...
public class ManualInputBarCodeActivity extends BaseActivity {
    ...
    private void defaultInvokeSystemInputSoft() {
        ...
        timer.schedule(new TimerTask() {
            public void run() {
                InputMethodManager inputManager = (InputMethodManager) mEtInputCode.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
                inputManager.showSoftInput(mEtInputCode, 0);
            }
