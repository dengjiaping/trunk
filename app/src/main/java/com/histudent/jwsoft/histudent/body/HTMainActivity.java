...
public class HTMainActivity extends BaseActivity {
    ...
    private int mClassApplyHintMessageCount;
    ...
    public static void start(Activity activity) {
        Intent intent = new Intent(activity, HTMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!syncCompleted) {
            DialogMaker.showProgressDialog(HTMainActivity.this, "正在准备数据...").setCanceledOnTouchOutside(false);
        }
    ...
    private void loadListener() {
        mLLPublish.setOnClickListener((View view) -> {
            ...
            mPopupWindowPublishContent = PopupWindowPublishContent.create(HTMainActivity.this, RequestCodeModel.getInstence().PUBLIC, 200);
    ...
    public void onEvent(ExitBean bean) {
        ...
        ReminderHelper.getIntentce().showDialog(this, "下线通知", bean.getMsg(), "立即退出", new DialogButtonListener() {
            ...
            public void setOnDialogButtonListener() {
                ...
                SharedPreferencedUtils.setString(HTApplication.getInstance(), ParamKeys.TOKEN, null);
                helper.exitAction();
            }
            ...
            public void setOnDialogButtonListener() {
                ...
                SharedPreferencedUtils.setString(HTApplication.getInstance(), ParamKeys.TOKEN, null);
                helper.exitAction();
                LoginActivity.start(HTMainActivity.this);
            }
        });
    }
            ...
            public void onReceive(Context context, final Intent intent) {
                ...
                switch (intent.getAction()) {
                    ...
                    case TheReceiverAction.DELET_ABOUTMINE_COMMENT_01:
                        ...
                        CustomAlertDialog dialog = new CustomAlertDialog(HTMainActivity.this);
        ...
        switch (view.getId()) {
            ...
            case R.id.title_left:
                ...
                if (current_type == TYPE_MESSAGE) {
                    ...
                    Intent intent_myFriend = new Intent(HTMainActivity.this, MyFriendsActivity.class);
