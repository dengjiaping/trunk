...
import com.histudent.jwsoft.histudent.commen.zxing.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
    ...
    private Hashtable<DecodeHintType, Object> hints1;

    DecodeHandler(CaptureActivity activity) {
        multiFormatReader = new QRCodeReader();
        this.activity = activity;
        hints1 = new Hashtable<>();

        hints1.put(DecodeHintType.CHARACTER_SET, "utf-8");
        hints1.put(DecodeHintType.TRY_HARDER, Boolean.FALSE);
...
//    hints.put()
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        try {
            rawResult = multiFormatReader.decode(bitmap,hints1);
