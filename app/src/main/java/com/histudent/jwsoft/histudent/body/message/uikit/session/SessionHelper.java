package com.histudent.jwsoft.histudent.body.message.uikit.session;
...
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.AVChatAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.ActivityAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.FileAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.GuessAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.NoticeAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.SnapChatAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.TipAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.action.WorkAction;
import com.histudent.jwsoft.histudent.body.message.uikit.session.activity.MessageHistoryActivity;
import com.histudent.jwsoft.histudent.body.message.uikit.session.activity.MessageInfoActivity;
import com.histudent.jwsoft.histudent.body.message.uikit.session.extension.CustomAttachParser;
import com.histudent.jwsoft.histudent.body.message.uikit.session.extension.CustomAttachment;
...
import com.histudent.jwsoft.histudent.body.message.uikit.session.extension.RTSAttachment;
import com.histudent.jwsoft.histudent.body.message.uikit.session.extension.SnapChatAttachment;
import com.histudent.jwsoft.histudent.body.message.uikit.session.extension.StickerAttachment;
import com.histudent.jwsoft.histudent.body.message.uikit.session.search.SearchMessageActivity;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderAVChat;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderDefCustom;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderFile;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderGuess;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderHome;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderNotice;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderRTS;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderSnapChat;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderSticker;
import com.histudent.jwsoft.histudent.body.message.uikit.session.viewholder.MsgViewHolderTip;
import com.histudent.jwsoft.histudent.commen.cache.HiCache;
import com.histudent.jwsoft.histudent.commen.cache.NimUIKit;
...
public class SessionHelper {
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        String current_account = HiCache.getInstance().getLoginUserInfo().getUserId().replace("-", "");
    ...
    public static void startTeamSession(Context context, String tid, boolean isGroup) {
        SessionHelper.isGroup = isGroup;
                ...
                public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent data) {
                    if (requestCode == TeamRequestCode.REQUEST_CODE && resultCode == Activity.RESULT_OK) {
                        ...
                        if (result.equals(TeamExtras.RESULT_EXTRA_REASON_CREATE)) {
                            ...
                            startTeamSession(activity, tid, SessionHelper.isGroup);
                            activity.finish();
                        }
                    }
                }
...
//        if (teamCustomization == null) {
        ...
        if (classModel != null)
            if (HiCache.getInstance().getLoginUserInfo().getUserType() != 3) {//非教师账号
...
//        }
    ...
    private static void registerViewHolders() {
        ...
        NimUIKit.registerMsgItemViewHolder(HomeAttachment.class, MsgViewHolderHome.class);
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                // 一般用于打开用户资料页面
//                com.netease.nim.demo.contact.activity.UserProfileActivity.start(context, message.getFromAccount());
            }
