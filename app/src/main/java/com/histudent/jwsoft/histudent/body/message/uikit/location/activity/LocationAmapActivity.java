...
import com.histudent.jwsoft.histudent.body.message.uikit.location.helper.NimGeocoder;
...
//	private static final String TAG = "LocationAmapActivity";
    ...
    private IconView image_left;
    private TextView title_mid, titile_right;
...
//        setToolBar(R.id.toolbar, options);
    ...
    private void initView() {
        ...
        image_left = findView(R.id.title_left_image);
        title_mid = findView(R.id.title_middle_text);
...
//        sendButton = findView(R.id.action_bar_right_clickable_textview);
    ...
    private void initLocation() {
        locationManager = new NimLocationManager(this, this, amap, true);
...
//            setTitle(titleResID);
            title_mid.setText(titleResID);
        } else {
//            setTitle(R.string.my_location);
            title_mid.setText(R.string.my_location);
        }
    }
