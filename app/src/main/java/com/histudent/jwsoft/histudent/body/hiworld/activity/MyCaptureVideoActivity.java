 ...
 */
public class MyCaptureVideoActivity extends UI implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    public static void start(Activity activity, String videoFilePath, int captureCode, int flag) {
        ...
        intent.setClass(activity, MyCaptureVideoActivity.class);
    ...
    @Subscribe
    public void onEvent(ScreenSwitchEvent event) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_nim_capture_video_activity);
    ...
    private void findViews() {
        ...
        text_tip.setText(flag == 1 ? "轻触拍照" : flag == 3 ? "轻触拍照，按住摄像" : "按住摄像");
...
//            shutdownCamera();
    ...
    private void setVideoOrientation() {
        if (Build.VERSION.SDK_INT >= 9) {
            ...
            Log.d(getClass().getSimpleName(), "orientation----->" + orientation);
            Log.d(getClass().getSimpleName(), "front----->" + front);
            Log.d(getClass().getSimpleName(), "Nexus----->" + "Nexus 5X".equals(Build.MODEL));
...
//        activity.startActivityForResult(intent, resultCode);
        if (camera != null) {
            ...
            camera.takePicture(null, null, MyCaptureVideoActivity.this);
        }
    }
...
//        recordingTimeTextView.setText("00:00");
    ...
    public int setCameraDisplayOrientation(Context context, int cameraId, Camera camera) {
        ...
        int result;
        Log.d(getClass().getSimpleName(), "" + Build.MODEL);
        if (front) {
