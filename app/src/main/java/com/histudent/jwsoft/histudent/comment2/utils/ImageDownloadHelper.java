...
/**
 * Created by liuguiyu-pc on 2017/2/9.
 * 图片异步加载（自带缓存）
 */
...
public class ImageDownloadHelper {
     ...
     * @param mImageView
     * @param path             文件存储路径
     * @param downloadListener OnImageDownload回调接口，在onPostExecute()中被调用
     */

    public void imageDownload(Context context, String url, ImageView mImageView, String path, OnImageDownloadListener downloadListener) {
