package com.histudent.jwsoft.histudent.body.message.uikit.location.activity;
...
import com.histudent.jwsoft.histudent.body.message.uikit.location.adapter.IconListAdapter;
import com.histudent.jwsoft.histudent.body.message.uikit.location.helper.MapHelper;
import com.histudent.jwsoft.histudent.body.message.uikit.location.helper.NimLocationManager;
...
//        initWindow();
        ...
        ((TextView) findViewById(R.id.title_middle_text)).setText("位置信息");

        ((LinearLayout) findViewById(R.id.title_left)).setOnClickListener(new OnClickListener() {
            @Override
...
//		setToolBar(R.id.toolbar, options);
    ...
    private void initView() {
        HiStudentLog.e("-------location-------->initView");
        sendButton = findView(R.id.title_right_text);
    ...
    private void initAmap() {
        HiStudentLog.e("-------location-------->initAmap");
        try {
            amap = mapView.getMap();
    ...
    private void initLocation() {
        HiStudentLog.e("-------location-------->initLocation");
        locationManager = new NimLocationManager(this, this, amap, false);
    ...
    private void updateSendStatus() {
        HiStudentLog.e("-------location-------->updateSendStatus");
        if (isFinishing()) {
            return;
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        HiStudentLog.e("-------location-------->onSaveInstanceState");
    ...
    protected void onPause() {
        super.onPause();
        HiStudentLog.e("-------location-------->onPause");
        mapView.onPause();
    ...
    protected void onResume() {
        super.onResume();
        HiStudentLog.e("-------location-------->onResume");
        mapView.onResume();
    ...
    protected void onDestroy() {
        super.onDestroy();
        HiStudentLog.e("-------location-------->onDestroy");
        mapView.onDestroy();
        if (locationManager != null) {
            locationManager.deactivate();
        }
