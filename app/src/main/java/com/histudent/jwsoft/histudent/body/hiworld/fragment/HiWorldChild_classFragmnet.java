 ...
 * 班级动态
 */
public class HiWorldChild_classFragmnet extends BaseFragment implements AllItemAdapter.AdapterCallBack {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.hiworldchild_classfragmnet, container, false);
        return view;
    }
    ...
    public void initView() {
        ...
        adapter_ = new AllItemAdapter(getActivity(), list_all, ItemType.HI_CLASS_ACTION, this);
        ...
        changeBackUtils.setFrame(frameLayout, 1);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == RequestCodeModel.getInstence().CLASS_ACTION_H) {
    ...
    private void getShowData(LoadingType flag) {
        ...
        HiStudentHttpUtils.postDataByOKHttp((BaseActivity) getActivity(), map_post, HistudentUrl.classAction_url, new HttpRequestCallBack() {
            @Override
