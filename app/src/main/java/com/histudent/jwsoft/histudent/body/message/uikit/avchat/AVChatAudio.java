package com.histudent.jwsoft.histudent.body.message.uikit.avchat;
...
import com.histudent.jwsoft.histudent.body.message.uikit.avchat.constant.CallStateEnum;
import com.histudent.jwsoft.histudent.body.message.uikit.avchat.widgets.ToggleListener;
import com.histudent.jwsoft.histudent.body.message.uikit.avchat.widgets.ToggleState;
import com.histudent.jwsoft.histudent.body.message.uikit.avchat.widgets.ToggleView;
...
//        recordToggle.disable(false);
        ...
        exhange = mute_speaker_hangup.findViewById(R.id.avchat_audio_exchange);
        exhange.setOnClickListener(this);
    ...
    private void showProfile() {
        ...
        nickNameTV.setText(NIMClient.getService(UserService.class).getUserInfo(account).getName());
    }
...
//        switchVideo.setVisibility(visible ? View.VISIBLE : View.GONE);
        exhange.setVisibility(View.GONE);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.avchat_audio_speaker:
                ...
                break;
            case R.id.avchat_audio_exchange:
